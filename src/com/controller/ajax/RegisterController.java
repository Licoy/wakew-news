...
import com.service.ajax.RegisterService;
...
@WebServlet(name = "RegisterController", urlPatterns = {"/ajax/RegisterController.do"})
public class RegisterController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        tipsMap = registerService.insertUser(user);
        jsonArray.put(tipsMap);
        try {
            response.getWriter().print(jsonArray.getString(0));
        } catch (JSONException e) {
