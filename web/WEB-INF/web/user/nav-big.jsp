...
${pageContext.setAttribute("title","大栏分类导航")}
${pageContext.setAttribute("tier",8)}
<!-- /Head -->
                                ...
                                <div>
                                    <form class="form-horizontal form-bordered" role="form">
                                        <div class="control-group text-align-center">
                                            <label>
                                                <input name="addNavBigChecked" id="addNavBigCheckedCats" type="radio" checked="checked">
                                                <span class="text">分类目录</span>
                                            </label>
                                            <label>
                                                <input name="addNavBigChecked" id="addNavBigCheckedUrl" type="radio" class="inverted">
                                                <span class="text">链接</span>
                                            </label>
                                        </div>
                                        <%--分类选择框--%>
                                        <div class="form-group addNavBigCats">
                                        ...
                                        <span class="addNavBigUrl">
                                            <div class="form-group margin-bottom-10">
                                                <label for="addNavBigUrlNames" class="col-sm-2 control-label no-padding-right">链接标题</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="addNavBigUrlNames" placeholder="链接标题">
                                                </div>
                                            </div>
                                            <div class="form-group margin-bottom-10">
                                                <label for="addNavBigUrlAddress" class="col-sm-2 control-label no-padding-right">链接地址</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="addNavBigUrlAddress" placeholder="链接地址">
                                                </div>
                                            </div>
                                        </span>
                                        <div class="form-group">
                                            <label for="addNavBigName" class="col-sm-2 control-label no-padding-right">导航名称</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="addNavBigName" placeholder="导航名称">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="addNavBigDesc" class="col-sm-2 control-label no-padding-right">优先级</label>
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" id="addNavBigDesc" placeholder="优先级">
                                            </div>
                                        </div>
